...
## What are the Self-Service APIs and Enterprise APIs?

Target independent developers and start-ups that wish to connect to Amadeus APIs in a quick and easy manner. You can access and start to test these new REST/JSON APIs in less than 3 minutes, and get quick access to production data with a flexible pay-as-you-go pricing model. Please note that the catalog includes some selected APIs, although we will be constantly releasing new APIs. We provide APIs for flights, hotels, destination content, and travel safety under the Self-Service APIs. With the Enterprise APIs, we cater to companies with scale needs and leading brands in the travel industry.

You can access our detailed documentation, guides, and SDKs to integrate the Self-Service APIs into your apps. 
...
## Discover the Amadeus Self-Service and Enterprise APIs
...
* To see all Explore Amadeus APIs in one place, check out our [API catalogue](https://developers.amadeus.com/self-service){:target="\_blank"}.
